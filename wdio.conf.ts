...
export const config: Options.Testrunner = {
    ...
    baseUrl: 'https://workday.wd5.myworkdayjobs.com/en-US/Workday/login',
    //
    ...
    afterTest: async ({ error}) => {
        if (error) {
          ...
          const screenshotPath = `./errorShots/screenshot-${timestamp}.png`;
          browser.saveScreenshot(screenshotPath);
    
          Reporter.addAttachment('Screenshot', screenshotPath, 'image/png');
        }
      },
